...
def launch_fibonacci_game():
    ...
    dragging_block = None
    score = 0
    hint_text = config.small_font.render(
    ...
    while True:
        ...
        if game_state.feedback_image:
            screen.blit(game_state.feedback_image, (
                config.SCREEN_WIDTH // 2 - game_state.feedback_image.get_width() // 2,
                config.SCREEN_HEIGHT // 2 - game_state.feedback_image.get_height() // 2))
        else:
