...
class DialogBox:
    def __init__(self, surface, width, height):
        ...
        self.bart_image = pygame.image.load(os.path.join(config.PIC_PATH, 'Bart.jpg'))
        self.bart_image = pygame.transform.scale(self.bart_image, (100,100))
        self.bart_image_rect = self.bart_image.get_rect(bottomright=(self.rect.right - 10, self.rect.bottom - 10))
        self.homelessMan_image = pygame.image.load(os.path.join(config.PIC_PATH, 'homelessMan.jpg'))
        self.homelessMan_image = pygame.transform.scale(self.homelessMan_image, (100,100))
        self.homelessMan_image_rect = self.homelessMan_image.get_rect(bottomright=(self.rect.right - 10, self.rect.bottom - 10))
    ...
    def show_dialog(self, message, auto_hide_seconds=None):
        ...
        if "Here is Level 1" in message:
            ...
            self.set_style((173, 216, 230), os.path.join('pic', 'Bart.jpg'))
        elif 'Spare Change ?' in message:
            self.set_style((173, 216, 230), os.path.join('pic', 'homelessMan.jpg'))
        elif 'Sorry man I dont have any' in message:
            self.set_style((173, 216, 230), os.path.join('pic', 'Bart.jpg'))
